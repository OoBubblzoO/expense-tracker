...
import { Table, TableData, Button, Text, Group, ScrollArea, Paper, TextInput, NumberInput, Stack, Title } from '@mantine/core';
...
const ExpenseTable = () => {
    ...
    return (
        <Stack spacing="lg">
            <Title order={2} align="center">Expense Tracker</Title>
